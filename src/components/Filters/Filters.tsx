...
import { changeFilter, FilterOption } from '@/store/filters/slice';

export interface FiltersProps {}

const Filters = ({}: FiltersProps) => {
  const filterValue = useAppSelector(selectValue);

  const dispatch = useAppDispatch();

  const handleChange = (event: SelectChangeEvent): void => {
    dispatch(changeFilter(event.target.value as FilterOption));
  };
